...
class Retell {
     ...
     */
    constructor({ baseURL = (0, env_1.readEnv)('RETELL_BASE_URL'), apiKey = (0, env_1.readEnv)('RETELL_API_KEY'), ...opts } = {}) {
        ...
        if (apiKey === undefined) {
            throw new Errors.RetellError("The RETELL_API_KEY environment variable is missing or empty; either provide it, or instantiate the Retell client with an apiKey option, like new Retell({ apiKey: 'YOUR_RETELL_API_KEY' }).");
        }
        const options = {
            apiKey,
            ...opts,
